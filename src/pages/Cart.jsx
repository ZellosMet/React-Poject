  ...
  return (
    <section className="cart min-h-80">
      <div className="max-w-7xl mx-auto px-2">
        <Link
          to="/cards" className=" text-indigo-500 hover:text-indigo-600 mb-8 inline-flex">◀️ Go to page Cards
        </Link>
        <div className="flex justify-between items-start">
          ...
          {cart?.length > 0 && (
            <button onClick={() => navigate(`/cart/checkout`)} className="bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 px-4 rounded">
              Checkout
            </button>
          )}
        </div>
